...
export class AdminSectionService {
  constructor(private readonly repository: AdminSectionRepository) {}

  async create(courseId: string, createSectionDto: CreateSectionDto) {
    ...
    const section = await this.repository.create(courseId, createSectionDto);
